...
CREATE TABLE IF NOT EXISTS `videos` (
    ...
    `vimeo_download_url` VARCHAR(255) DEFAULT NULL COMMENT 'Vimeo-reviewlink met downloadknop',
    `download_after`     DATE         DEFAULT NULL COMMENT 'Vanaf deze datum is downloaden toegestaan',
...
-- ------------------------------------------------------------
-- 9. Login IP-tracking (tegengaan login delen)
--    Max 3 unieke IP's per gebruiker binnen IP_TRACK_TTL.
--    Bij een 4e nieuw IP wordt video-toegang geblokkeerd.
-- ------------------------------------------------------------
...
-- ------------------------------------------------------------
-- 10. Video-weergaven tracking
--     Bijgehouden wanneer iemand een video start met bekijken.
-- ------------------------------------------------------------
